...
class ConfirmWithdrawScreen extends StatefulWidget {
  const ConfirmWithdrawScreen({Key? key, required this.model})
      : super(key: key);
...
class _ConfirmWithdrawScreenState extends State<ConfirmWithdrawScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(
        WithdrawConfirmController(profileRepo: Get.find(), repo: Get.find()));
              ...
              controller.isLoading
                  ...
                  : Align(
                      ...
                      child: SingleChildScrollView(
                        child: Container(
                          padding:
                              const EdgeInsets.all(Dimensions.fontExtraLarge),
