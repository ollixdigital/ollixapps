                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border(bottom: BorderSide(color: controller.countryName == null ? MyColor.getFieldDisableBorderColor() : MyColor.getFieldEnableBorderColor()))
                            ),
                            child: Text("+${controller.mobileCode}",
                              style: interRegularDefault.copyWith(color: MyColor.getPrimaryColor()),
                            ),
                          ),
