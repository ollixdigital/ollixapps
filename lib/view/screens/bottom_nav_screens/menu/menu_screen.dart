...
import 'package:hyip_lab/data/controller/menu/menu_controller.dart';
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(Menu_Controller(repo: Get.find()));
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ThemeController>(builder: (theme) {
      return GetBuilder<LocalizationController>(
        ...
        return GetBuilder<Menu_Controller>(
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Visibility(
                                          visible:
                                              menuController.balTransferEnable,
                                          child: Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Visibility(
                                          visible:
                                              menuController.langSwitchEnable,
                                          child: Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
                                      ...
                                      MenuRowWidget(
                                        ...
                                        onPressed: () {
                                          ...
                                          controller.loginRepo.apiClient
                                              .sharedPreferences
                                              .setBool(
                                                  SharedPreferenceHelper
                                                      .rememberMeKey,
                                          ...
                                          CustomSnackBar.showCustomSnackBar(
                                              errorList: [],
                                              msg: [MyStrings.logoutSuccessMsg],
                                              isError: false);
                                          Get.offAllNamed(
