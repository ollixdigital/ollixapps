                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(controller.getAmount(widget.index) ?? "", textAlign: TextAlign.center,style: interRegularLarge.copyWith(color: MyColor.getPrimaryColor() ,fontWeight: FontWeight.w500)),
                    ],
                  ),
                  InkWell(
                    onTap: (){
                    ...
                    child: widget.index == controller.selectedIndex ? Icon(Icons.keyboard_arrow_up, color: MyColor.getPrimaryColor(), size: 25) : Icon(Icons.keyboard_arrow_down, color: MyColor.getPrimaryColor(), size: 25),
                  )
                ],
              ),
              ExpandedSection(
