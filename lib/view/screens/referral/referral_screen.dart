                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                            ...
                            child: DottedBorder(
                              ...
                              child: Center(
                                child: Padding(
                                  ...
                                  child: Text(
                                    "${UrlContainer.domainUrl}${controller.referralRepo.apiClient.getCurrencyOrUsername(isCurrency: false)}",
                        ...
                        GestureDetector(
                          onTap: (){
                            Clipboard.setData(ClipboardData(text:  "${UrlContainer.domainUrl}${controller.referralRepo.apiClient.getCurrencyOrUsername(isCurrency: false)}"));
