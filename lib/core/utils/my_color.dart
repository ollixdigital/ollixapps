...
class MyColor{
  ...
  static const Color primaryColor = Color(0xffCBA352);

  static const Color backgroundColor =  Color(0xff0D222B);
  static const Color splashBgColor =  Color(0xffCBA352);
  static const Color appBarColor = Color(0xff192D36);

  static const Color fieldEnableBorderColor = Color(0xffCBA352);
  ...
  static const Color secondaryTextColor = Color(0xffCBA352);
  ...
  static const Color colorGolden = Color(0xffCBA352);
